...
class MainWindow(QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        try:
            ...
            print(f"Saved window geometry: x={geometry.x()}, y={geometry.y()}, w={geometry.width()}, h={geometry.height()}")
    ...
    def add_kill_event(self, event_data, update_session=True):
        ...
        try:
            ...
            should_process = (
                (is_self_event and self.self_events_check.isChecked()) or
                (is_other_event and self.other_events_check.isChecked()) or
                (is_npc and self.npc_events_check.isChecked()) or
                (is_suicide and self.suicide_events_check.isChecked()) or
                (is_party_event and self.party_events_check.isChecked())
            )
